...
$('#refund-finder-button').on('click', function(e){
	$.post('https://api.sendgrid.com/api/mail.send.json', {
		...
		from: 'travel-troll@scrimpist.com',
		html: messageHtml
        ...
        <tbody><tr>
          <td style="padding: 0;vertical-align: top">
            <table style="border-collapse: collapse;border-spacing: 0;width: 602px">
              <tbody><tr>
                <td class="title" style="padding: 0;vertical-align: top;padding-top: 10px;padding-bottom: 12px;font-size: 12px;line-height: 21px;text-align: left;color: #999;font-family: Georgia,serif">We caught a price drop for you.</td>
          ...
          <table class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto">
            ...
            <h1 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 36px;Margin-bottom: 18px;font-family: sans-serif;line-height: 42px;text-align: center"><strong style="font-weight: bold">SCRIMPIST</strong></h1>
            ...
            <h1 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 36px;Margin-bottom: 18px;font-family: sans-serif;line-height: 42px">You got a Credit!</h1><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Congratulations Matthew, we got you a $179 credit on your flight to Phoenix (PHX) on April 30th. We\'ve charged your card ending in ***2453 for the transaction.</p>
            ...
            <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">&nbsp;</p><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Thanks for using Scrimpist to track your flight. We\'re committed to making travel easier by tracking all your travel booking prices.</p><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 24px"><a style="text-decoration: underline;transition: all .2s;color: #41637e" data-emb-href-display="scrimpist.com" href="http://scrimpist.com">Sign in</a>&nbsp;to your account to make changes to individual bookings.</p>
                  ...
                  <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                    <tbody><tr>
                      <td class="padded" style="padding: 0;vertical-align: top;padding-left: 10px;padding-right: 0;word-break: break-word;word-wrap: break-word;font-size: 12px;line-height: 20px;color: #999;font-family: Georgia,serif;text-align: right">
                        <div>You either signed up or sent us an a confirmation email.</div>
                        <div>
                          <span class="block">
                            <span>
                              <a href="www.scrimpist.com" style="font-weight:bold;text-decoration:none;" lang="en">
                                Preferences
                              </a>
                              <span class="hide">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                            </span>
                          </span>
                          <span class="block"><a href="www.scrimpist.com" style="font-weight:bold;text-decoration:none;">Unsubscribe</a></span>
                        </div>
                      </td>
                    </tr>
                  </tbody></table>
